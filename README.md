...
[схема взаимодействия сервисов](theory/img/C4.png)
...
#### Установка инфраструктурных компонентов (дождаться завершения выполнения файла)
```
./install-core.sh
```

#### Установка сервисов (дождаться завершения выполнения файла)
```
./install-services.sh
```
...
```
newman run ./postman/HW7.json
```


### КАК УДАЛИТЬ
#### Удаляем сервисы (дожидаемся окончания удаления сервисов)
```
./uninstall-services.sh
```

#### Удаляем инфраструктурные компоненты (опционально)
```
./uninstall-core.sh
```
